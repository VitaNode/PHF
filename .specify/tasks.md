...
| ID | 任务描述 | 复杂度 | 类型 | 依赖关系 | 宪章引用 |
| :--- | :--- | :--- | :--- | :--- | :--- |
| **T3.4.1** [x]| **首页 PersonnelTabs 组件**: 实现胶囊式滑动 Tab，支持人员切换动画过渡，最 右侧带 `[+]` 入口。 | 中 | 依赖任务 | T3.3.1 | VI. UI/UX 准则 |
...
| ID | 任务描述 | 复杂度 | 类型 | 依赖关系 | 宪章引用 |
| :--- | :--- | :--- | :--- | :--- | :--- |
| **T3.5.1** [x]| **可折叠 OCR 全文组件**: 在标签下方实现折叠文本域，默认 3-4 行，支持展开/折叠查看完整 OCR。 | 低 | 独立任务 | - | VI. UI/UX 准则 |
