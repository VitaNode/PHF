...
@override
String toString() {
  return 'OcrElement(text: $text, x: $x, y: $y, w: $w, h: $h, confidence: $confidence)';
}
...
class _OcrElement implements OcrElement {
  const _OcrElement({required this.text, @JsonKey(readValue: _readX) required this.x, @JsonKey(readValue: _readY) required this.y, @JsonKey(readValue: _readW) required this.w, @JsonKey(readValue: _readH) required this.h, this.confidence = 0.0});
...
mixin _$OcrLine {
 ...
 String get text;@JsonKey(readValue: _readX) double get x;@JsonKey(readValue: _readY) double get y;@JsonKey(readValue: _readW) double get w;@JsonKey(readValue: _readH) double get h; List<OcrElement> get elements; double get confidence;
...
@useResult
$Res call({
 String text,@JsonKey(readValue: _readX) double x,@JsonKey(readValue: _readY) double y,@JsonKey(readValue: _readW) double w,@JsonKey(readValue: _readH) double h, List<OcrElement> elements, double confidence
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String text, @JsonKey(readValue: _readX)  double x, @JsonKey(readValue: _readY)  double y, @JsonKey(readValue: _readW)  double w, @JsonKey(readValue: _readH)  double h,  List<OcrElement> elements,  double confidence)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _OcrLine() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String text, @JsonKey(readValue: _readX)  double x, @JsonKey(readValue: _readY)  double y, @JsonKey(readValue: _readW)  double w, @JsonKey(readValue: _readH)  double h,  List<OcrElement> elements,  double confidence)  $default,) {final _that = this;
switch (_that) {
case _OcrLine():
return $default(_that.text,_that.x,_that.y,_that.w,_that.h,_that.elements,_that.confidence);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String text, @JsonKey(readValue: _readX)  double x, @JsonKey(readValue: _readY)  double y, @JsonKey(readValue: _readW)  double w, @JsonKey(readValue: _readH)  double h,  List<OcrElement> elements,  double confidence)?  $default,) {final _that = this;
switch (_that) {
case _OcrLine() when $default != null:
return $default(_that.text,_that.x,_that.y,_that.w,_that.h,_that.elements,_that.confidence);case _:
  return null;
...
class _OcrLine implements OcrLine {
  const _OcrLine({required this.text, @JsonKey(readValue: _readX) required this.x, @JsonKey(readValue: _readY) required this.y, @JsonKey(readValue: _readW) required this.w, @JsonKey(readValue: _readH) required this.h, final  List<OcrElement> elements = const [], this.confidence = 0.0}): _elements = elements;
...
mixin _$OcrBlock {
 ...
 String get text;@JsonKey(readValue: _readX) double get x;@JsonKey(readValue: _readY) double get y;@JsonKey(readValue: _readW) double get w;@JsonKey(readValue: _readH) double get h; List<OcrLine> get lines; double get confidence;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,text,x,y,w,h,const DeepCollectionEquality().hash(lines),confidence);

@override
String toString() {
  return 'OcrBlock(text: $text, x: $x, y: $y, w: $w, h: $h, lines: $lines, confidence: $confidence)';
}
...
@useResult
$Res call({
 String text,@JsonKey(readValue: _readX) double x,@JsonKey(readValue: _readY) double y,@JsonKey(readValue: _readW) double w,@JsonKey(readValue: _readH) double h, List<OcrLine> lines, double confidence
});
...
/// Create a copy of OcrBlock
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? text = null,Object? x = null,Object? y = null,Object? w = null,Object? h = null,Object? lines = null,Object? confidence = null,}) {
  return _then(_self.copyWith(
text: null == text ? _self.text : text // ignore: cast_nullable_to_non_nullable
as String,x: null == x ? _self.x : x // ignore: cast_nullable_to_non_nullable
as double,y: null == y ? _self.y : y // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String text, @JsonKey(readValue: _readX)  double x, @JsonKey(readValue: _readY)  double y, @JsonKey(readValue: _readW)  double w, @JsonKey(readValue: _readH)  double h,  List<OcrLine> lines,  double confidence)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _OcrBlock() when $default != null:
return $default(_that.text,_that.x,_that.y,_that.w,_that.h,_that.lines,_that.confidence);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String text, @JsonKey(readValue: _readX)  double x, @JsonKey(readValue: _readY)  double y, @JsonKey(readValue: _readW)  double w, @JsonKey(readValue: _readH)  double h,  List<OcrLine> lines,  double confidence)  $default,) {final _that = this;
switch (_that) {
case _OcrBlock():
return $default(_that.text,_that.x,_that.y,_that.w,_that.h,_that.lines,_that.confidence);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String text, @JsonKey(readValue: _readX)  double x, @JsonKey(readValue: _readY)  double y, @JsonKey(readValue: _readW)  double w, @JsonKey(readValue: _readH)  double h,  List<OcrLine> lines,  double confidence)?  $default,) {final _that = this;
switch (_that) {
case _OcrBlock() when $default != null:
return $default(_that.text,_that.x,_that.y,_that.w,_that.h,_that.lines,_that.confidence);case _:
  return null;
...
class _OcrBlock implements OcrBlock {
  const _OcrBlock({required this.text, @JsonKey(readValue: _readX) required this.x, @JsonKey(readValue: _readY) required this.y, @JsonKey(readValue: _readW) required this.w, @JsonKey(readValue: _readH) required this.h, final  List<OcrLine> lines = const [], this.confidence = 0.0}): _lines = lines;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,text,x,y,w,h,const DeepCollectionEquality().hash(_lines),confidence);
...
/// Create a copy of OcrBlock
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? text = null,Object? x = null,Object? y = null,Object? w = null,Object? h = null,Object? lines = null,Object? confidence = null,}) {
